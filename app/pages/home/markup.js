...
// langkah terpisah nanti. Link tiap modul DIBIARKAN SAMA PERSIS seperti di
// index.html lama (masih `/app/shell.html#...` untuk yang sudah migrated,
// masih `/nama.html` untuk yang legacy) — belum diubah ke `location.hash`.
...
export const MODULES = [
  ...
  },
  {
    ...
    url: '/app/shell.html#kompres-pdf',
    color: '#EF4444',
  ...
  },
  {
    ...
    url: '/app/shell.html#export-gambar',
    color: '#10B981',
